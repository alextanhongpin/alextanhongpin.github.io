...
define('core/Spark', ['require', 'exports', 'core/particle'], function (require, exports, particle_1) {
  'use strict'
  Object.defineProperty(exports, '__esModule', { value: true })
  ...
  var Spark = (function () {
    ...
    Spark.prototype.setup = function (_body) {
      this.particles = Array(this.count).fill(0).map(function (_, _i) {
...
define('composite/asteroid', ['require', 'exports', 'mixin/damageable', 'utils/mixin', 'drawable/asteroid', 'core/body', 'core/Spark', 'utils/Observer'], function (require, exports, damageable_1, mixin_1, asteroid_1, body_1, Spark_1, Observer_1) {
  'use strict'
  Object.defineProperty(exports, '__esModule', { value: true })
...
define('mixin/weaponizable', ['require', 'exports', 'core/weapon'], function (require, exports, weapon_1) {
  'use strict'
  Object.defineProperty(exports, '__esModule', { value: true })
...
define('mixin/teleportable', ['require', 'exports', 'utils/math2', 'core/particle'], function (require, exports, math2_1, particle_2) {
  'use strict'
  Object.defineProperty(exports, '__esModule', { value: true })
  ...
  var Teleportable = (function () {
    ...
    Teleportable.prototype._makeParticles = function (count, x, y) {
      ...
      return Array(count).fill(0).map(function (_, i) {
        var theta = math2_1.default.degreeToTheta(degree * i)
    ...
    Teleportable.prototype._teleport = function (body) {
      ...
      body.x = math2_1.default.random(0, window.innerWidth)
      body.y = math2_1.default.random(0, window.innerHeight)
    }
...
define('composite/ship', ['require', 'exports', 'mixin/damageable', 'mixin/weaponizable', 'mixin/teleportable', 'utils/mixin', 'drawable/ship', 'core/body', 'utils/keycode', 'utils/math2', 'utils/Observer'], function (require, exports, damageable_2, weaponizable_1, teleportable_1, mixin_2, ship_1, body_2, keycode_1, math2_2, observer_1) {
  'use strict'
  Object.defineProperty(exports, '__esModule', { value: true })
    ...
    CompositeShip.prototype._bindEvents = function () {
      ...
      document.addEventListener('keydown', function (evt) {
        ...
        if (evt.keyCode === keycode_1.default.Left) {
          _this.rotate(-math2_2.default.degreeToTheta(10))
        }
...
define('core/Game', ['require', 'exports', 'utils/keycode', 'composite/asteroid', 'composite/ship', 'composite/alien', 'core/weapon', 'utils/Observer', 'utils/math2'], function (require, exports, keycode_2, asteroid_2, ship_2, alien_2, weapon_2, Observer_3, math2_3) {
  'use strict'
  Object.defineProperty(exports, '__esModule', { value: true })
  ...
  var Game = (function () {
    ...
    Game.prototype._shipWeaponAndAsteroidCollision = function (weapon, asteroid, asteroidId) {
      ...
      Object.entries(weapon.ammos).forEach(function (_a) {
        ...
        if (weapon.type === weapon_2.WeaponType.Bullet) {
          if (ammo.collision(asteroid)) {
            ...
            _this.observer.emit('message', shootAsteroidMessages[math2_3.default.random(0, shootAsteroidMessages.length - 1)])
            if (asteroid.hp < 0) {
              delete _this.bodies[Number(asteroidId)]
            }
          }
        } else if (weapon.type === weapon_2.WeaponType.Laser) {
    ...
    Game.prototype._shipAndAsteroidCollision = function (asteroid, ship, shipId) {
      if (asteroid.collision(ship)) {
        ...
        this.observer.emit('message', asteroidMessages[math2_3.default.random(0, asteroidMessages.length - 1)])
        if (ship.hp < 0) {
    ...
    Game.prototype._alienWeaponAndShipCollision = function (weapon, ship, shipId) {
      ...
      Object.entries(weapon.ammos).forEach(function (_a) {
        ...
        if (ammo.collision(ship)) {
          ...
          _this.observer.emit('message', alientAttackMessages[math2_3.default.random(0, alientAttackMessages.length - 1)])
          if (ship.hp < 0) {
...
define('factory/ship', ['require', 'exports', 'composite/ship', 'core/bullet', 'core/weapon', 'core/laser'], function (require, exports, ship_3, bullet_1, weapon_3, laser_1) {
  'use strict'
  Object.defineProperty(exports, '__esModule', { value: true })
  ...
  var ShipFactory = (function () {
    ...
    ShipFactory.prototype.makeBullet = function () {
      ...
      var velocity = 5
      var duration = 7500
      return new bullet_1.default(weapon_3.WeaponType.Bullet, count, radius, velocity, duration)
    }
    ShipFactory.prototype.makeLaser = function () {
      ...
      var velocity = 0
      var duration = 500
      return new laser_1.default(weapon_3.WeaponType.Laser, count, radius, velocity, duration)
    }
...
define('factory/alien', ['require', 'exports', 'composite/alien', 'core/bullet', 'core/weapon', 'utils/math2'], function (require, exports, alien_3, bullet_2, weapon_4, Math2_2) {
  'use strict'
  Object.defineProperty(exports, '__esModule', { value: true })
  ...
  var AlienFactory = (function () {
    ...
    AlienFactory.prototype.makeBullet = function () {
      ...
      var velocity = 5
      var duration = 7500
      return new bullet_2.default(weapon_4.WeaponType.Bullet, count, radius, velocity, duration)
    }
...
define('core/effect', ['require', 'exports', 'utils/math2', 'core/particle'], function (require, exports, math2_4, particle_3) {
  'use strict'
  Object.defineProperty(exports, '__esModule', { value: true })
  ...
  var Effect = (function () {
    ...
    Effect.prototype.setup = function (body) {
      ...
      this.particles = Array(this.count).fill(0).map(function (_, i) {
        var theta = math2_4.default.degreeToTheta(degree * i)
        var thetaX = Math.cos(theta)
        var thetaY = Math.sin(theta)
        var spread = 25
