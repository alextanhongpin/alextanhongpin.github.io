...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$a, 106, 2, 2411);
    		},
    ...
    function create_each_block$3(ctx) {
    	...
    	function click_handler(...args) {
    		return /*click_handler*/ ctx[15](/*it*/ ctx[17], ...args);
    	}

    	const block = {
    		c: function create() {
    			img = element("img");
    			if (img.src !== (img_src_value = /*folderPath*/ ctx[1] + /*it*/ ctx[17].name)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", img_alt_value = /*folderPath*/ ctx[1] + /*it*/ ctx[17].name);
    			attr_dev(img, "class", "img-modal svelte-c2vst8");
    			toggle_class(img, "is-selected", /*folderPath*/ ctx[1] + /*it*/ ctx[17].name === /*$src*/ ctx[5]);
    			add_location(img, file$a, 114, 8, 2641);
    		},
    		m: function mount(target, anchor, remount) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (!current || dirty & /*folderPath, images*/ 3 && img.src !== (img_src_value = /*folderPath*/ ctx[1] + /*it*/ ctx[17].name)) {
    				attr_dev(img, "src", img_src_value);
    			}

    			if (!current || dirty & /*folderPath, images*/ 3 && img_alt_value !== (img_alt_value = /*folderPath*/ ctx[1] + /*it*/ ctx[17].name)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(114:6) {#each images as it}",
    		ctx
    	});
    			...
    			case 37:
    				{
    					...
    					$$invalidate(4, container.scrollLeft = container.scrollWidth / images.length * (index - 1) - window.innerWidth / 2, container);
    			...
    			case 39:
    				{
    					...
    					$$invalidate(4, container.scrollLeft = container.scrollWidth / images.length * (index + 1) - window.innerWidth / 2, container);
    					onClick(folderPath + images[Math.min(index + 1, images.length - 1)].name);
    					return;
    				}
    		}
    	};
