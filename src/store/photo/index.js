  ...
  state: {
    ...
    photos: {
      'christmas-market': {
        ...
        images: [
          { name: '043.JPG', dof: 'f/1.4', shutterSpeed: '1/220 sec', iso: '200' },
          { name: '046.JPG', dof: 'f/1.4', shutterSpeed: '1/480 sec', iso: '200' },
          { name: '050.JPG', dof: 'f/1.4', shutterSpeed: '1/160 sec', iso: '200' },
          { name: '052.JPG', dof: 'f/1.4', shutterSpeed: '1/450 sec', iso: '200' },
          { name: '054.JPG', dof: 'f/1.4', shutterSpeed: '1/52 sec', iso: '320' },

          { name: '055.JPG', dof: 'f/1.4', shutterSpeed: '1/56 sec', iso: '200' },
          { name: '057.JPG', dof: 'f/1.4', shutterSpeed: '1/70 sec', iso: '200' },
          { name: '058.JPG', dof: 'f/1.4', shutterSpeed: '1/52 sec', iso: '200' },
          { name: '059.JPG', dof: 'f/1.4', shutterSpeed: '1/70 sec', iso: '200' },
          { name: '078.JPG', dof: 'f/1.4', shutterSpeed: '1/52 sec', iso: '2500' },

          { name: '088.JPG', dof: 'f/1.4', shutterSpeed: '1/52 sec', iso: '2500' },
          { name: '095.JPG', dof: 'f/1.4', shutterSpeed: '1/52 sec', iso: '3200' },
          { name: '104.JPG', dof: 'f/1.4', shutterSpeed: '1/52 sec', iso: '2000' }
        ],
        cameraModel: 'Fujifilm XE-1',
        lensModel: 'Fuji XF 35 mm f/1.4'
      },
      'malaysia': {
        heading: 'Malaysia',
        ...
        images: [
          { name: '336.JPG', dof: 'f/3.2', shutterSpeed: '1/3000 sec', iso: '200' },
          { name: '342.JPG', dof: 'f/2.8', shutterSpeed: '1/4000 sec', iso: '200' },
          { name: '346.JPG', dof: 'f/2.8', shutterSpeed: '1/300 sec', iso: '800' },
          { name: '348.JPG', dof: 'f/2.8', shutterSpeed: '1/90 sec', iso: '400' },
          { name: '351.JPG', dof: 'f/2.8', shutterSpeed: '1/160 sec', iso: '100' },

          { name: '353.JPG', dof: 'f/2.8', shutterSpeed: '1/56 sec', iso: '100' },
          { name: '363.JPG', dof: 'f/2.8', shutterSpeed: '1/1900 sec', iso: '800' },
          { name: '366.JPG', dof: 'f/1.4', shutterSpeed: '1/3500 sec', iso: '200' },
          { name: '368.JPG', dof: 'f/1.4', shutterSpeed: '1/180 sec', iso: '800' },
          { name: '370.JPG', dof: 'f/1.4', shutterSpeed: '1/2200 sec', iso: '800' },

          { name: '373.JPG', dof: 'f/1.4', shutterSpeed: '1/2400 sec', iso: '400' },
          { name: '379.JPG', dof: 'f/1.4', shutterSpeed: '1/1400 sec', iso: '200' },
          { name: '381.JPG', dof: 'f/1.4', shutterSpeed: '1/90 sec', iso: '800' },
          { name: '415.JPG', dof: 'f/13', shutterSpeed: '1/2400 sec', iso: '800' },
          { name: '423.JPG', dof: 'f/1.4', shutterSpeed: '1/550 sec', iso: '800' },

          { name: '424.JPG', dof: 'f/1.4', shutterSpeed: '1/1100 sec', iso: '200' },
          { name: '425.JPG', dof: 'f/1.4', shutterSpeed: '1/1000 sec', iso: '200' },
          { name: '426.JPG', dof: 'f/1.4', shutterSpeed: '1/900 sec', iso: '200' }
        ],
        cameraModel: 'Fujifilm XE-1',
        lensModel: 'Fuji XF 35 mm f/1.4'
      },
      'danboard': {
        ...
        images: [
          { name: '4735.jpg', dof: 'f/2.8', shutterSpeed: '1/50 sec', iso: '1600' },
          { name: '2630.jpg', dof: 'f/2.8', shutterSpeed: '1/20 sec', iso: '800' },
          { name: '2641.jpg', dof: 'f/2.8', shutterSpeed: '1/20 sec', iso: '800' },
          { name: '3166.jpg', dof: 'f/5', shutterSpeed: '1/60 sec', iso: '200' },

          { name: '3171.jpg', dof: 'f/3.5', shutterSpeed: '1/125 sec', iso: '200' },
          { name: '3174.jpg', dof: 'f/5', shutterSpeed: '1/125 sec', iso: '200' },
          { name: '3175.jpg', dof: 'f/5', shutterSpeed: '1/80 sec', iso: '200' },
          { name: '3619.jpg', dof: 'f/3.5', shutterSpeed: '1/60 sec', iso: '100' }

        ],
        cameraModel: 'Canon EOS 600D',
        lensModel: '100mm f/2.8 Macro Lens'
      },
      'preiser-figure': {
        ...
        images: [
          ...
          { name: '06.jpg', dof: 'f/2.8', shutterSpeed: '1/30 sec', iso: '400' },
        ...
        cameraModel: 'Canon EOS 600D',
        lensModel: '100mm f/2.8 Macro Lens'// 'Canon EF 100mm f/2.8 USM Macro Lens'
      },
      'berlin': {
        heading: 'Berlin Trip',
